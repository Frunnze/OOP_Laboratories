...
public:
    ...
    int speak_to_reception(string Gender)
    {
        srand(time(0));
        int option = 1 + (rand() % 6);
        if (Gender == "male")
    ...
    void go_to_exchange_window(int amount, string Gender)
    {
...
int main()
{
    ...
    switch (option)
    {
        ...
        case 1: 
        {
            ...
            int question_option = customer_1.speak_to_reception(employee_1.get_gender());
            ...
            if (question_option == 1)
            {
                ...
                customer_1.go_to_exchange_window(amount_to_change, customer_1.get_gender());
